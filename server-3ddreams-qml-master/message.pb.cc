...
NetClientRes::NetClientRes(const NetClientRes& from)
  ...
  if (!from._internal_errormesg().empty()) {
    errormesg_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_errormesg(),
      GetArena());
  }
...
MachineConfig::MachineConfig(const MachineConfig& from)
  ...
  if (!from._internal_machineno().empty()) {
    machineno_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_machineno(),
      GetArena());
  }
  ::memcpy(&packetcode_, &from.packetcode_,
