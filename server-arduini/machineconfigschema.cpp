...
//    cout << "getSqlInsertCommand :"<< temp<<endl;
    qDebug() << "MachineConfigSchema: getSqlInsertCommand: getSqlInsertCommand: " << QString::fromStdString(temp);
...
//    cout << "getSqlUpdateCommand :"<< temp<<endl;
    qDebug() << "MachineConfigSchema: getSqlUpdateCommand: getSqlUpdateCommand: " << QString::fromStdString(temp);
...
//   cout << "getSqlRemoveCommand :"<< temp;
   qDebug() << "MachineConfigSchema: getSqlRemoveCommand: getSqlRemoveCommand: " << QString::fromStdString(temp);
...
//   cout << "getSqlFindById :"<< temp;
   qDebug() << "MachineConfigSchema: getSqlFindById: getSqlFindById: " << QString::fromStdString(temp);
...
//    cout << "getSqlFindById :"<< temp;
    qDebug() << "MachineConfigSchema: getSqlFindByModelCode: getSqlFindByModelCode: " << QString::fromStdString(temp);
...
//    cout << "getSqlFindAll :"<< temp;
    qDebug() << "MachineConfigSchema: getSqlFindAll: getSqlFindAll: " << QString::fromStdString(temp);
