...
string MaterialSchema::getSqlInsertCommand()
{
    ...
    //    cout << "getSqlInsertCommand :"<< temp;
        qDebug() << "MaterialSchema: MaterialSchema: getSqlInsertCommand: " << QString::fromStdString(temp);
...
//    cout << "getSqlUpdateCommand :"<< temp;
    qDebug() << "MaterialSchema: MaterialSchema: getSqlUpdateCommand: " << QString::fromStdString(temp);
...
//   cout << "getSqlRemoveCommand :"<< temp;
   qDebug() << "MaterialSchema: MaterialSchema: getSqlRemoveCommand: " << QString::fromStdString(temp);
...
//   cout << "getSqlFindById :"<< temp;
   qDebug() << "MaterialSchema: getSqlFindById: getSqlFindById: " << QString::fromStdString(temp);
...
//    cout << "getSqlFindAll :"<< temp;
    qDebug() << "MaterialSchema: getSqlFindAll: getSqlFindAll: " << QString::fromStdString(temp);
