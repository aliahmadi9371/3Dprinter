...
QT_MOC_LITERAL(1, 11, 18), // "moduleDistanceData"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 1), // "d"
QT_MOC_LITERAL(4, 33, 17) // "recieveSerialPort"

    },
    "SerialPort\0moduleDistanceData\0\0d\0"
    "recieveSerialPort"
};
...
void SerialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->moduleDistanceData((*reinterpret_cast< float(*)>(_a[1]))); break;
        case 1: _t->recieveSerialPort(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SerialPort::*)(float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialPort::moduleDistanceData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SerialPort::moduleDistanceData(float _t1)
{
