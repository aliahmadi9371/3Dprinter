...
string JobSchema::getSqlInsertCommand()
{
    ...
    qDebug() << "JobSchema: getSqlInsertCommand: getSqlInsertCommand: " << QString::fromStdString(temp);
...
//    rowId = rowId + 1;
    ...
    qDebug() << "JobSchema: getSqlUpdateCommand: getSqlUpdateCommand: " << QString::fromStdString(temp);
...
//   rowId = rowId + 1;
   ...
   qDebug() << "JobSchema: getSqlRemoveCommand: getSqlRemoveCommand: " << QString::fromStdString(temp);
...
//    rowId = rowId + 1;
   ...
   qDebug() << "JobSchema: getSqlFindById: getSqlFindById: " << QString::fromStdString(temp);
...
string JobSchema::getSqlFindAll()
{
    ...
    qDebug() << "JobSchema: getSqlFindAll: getSqlFindAll: " << QString::fromStdString(temp);
